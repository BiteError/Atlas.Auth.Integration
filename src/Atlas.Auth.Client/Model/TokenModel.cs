...
namespace Atlas.Auth.Client.Model
{
    ...
    public partial class TokenModel :  IEquatable<TokenModel>, IValidatableObject
    {
        ...
        public TokenModel(string Token = default(string), DateTime? ExpiredAt = default(DateTime?))
        {
            this.Token = Token;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as TokenModel);
        }

        /// <summary>
        /// Returns true if TokenModel instances are equal
        /// </summary>
        /// <param name="other">Instance of TokenModel to be compared</param>
        /// <returns>Boolean</returns>
